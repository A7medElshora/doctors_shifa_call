...
class _ApiService implements ApiService {
  _ApiService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://185.135.137.90:44302/webapi/';
  }
  ...
  Future<List<Day>> getDays() async {
    ...
    final _options = _setStreamType<List<Day>>(
  ...
  Future<DoctorTimeTable> getDoctorTimeTable(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DoctorTimeTable>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<List<PriceModel>> getDoctorPrices(String doctorId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<PriceModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<List<TerminationStatus>> getTerminationStatuses() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<TerminationStatus>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'reservations/get_termination_status',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<void> updateBookingStatus(int reservationId, int statusId) async {
    ...
    final queryParameters = <String, dynamic>{
      ...
      r'Termination_status_id': statusId,
    };
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<void>(
  ...
  Future<List<SpecialtyModel>> getSpecialties() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<SpecialtyModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<SpecialtyModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => SpecialtyModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
